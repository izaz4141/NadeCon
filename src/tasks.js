...
function HandshakeTask (id)
{
    IpcTask.call (this, id, "handshake");
    this.handshake = new Object;
    this.handshake.api_version = "1";
    this.handshake.browser = window.browserName;
}

function UiStringsTask (id)
{
    IpcTask.call (this, id, "ui_strings");
}

function QuerySettingsTask (id)
{
    IpcTask.call (this, id, "query_settings");
}

function PostSettingsTask (id)
{
    IpcTask.call (this, id, "post_settings");
...
function JsonTask (id)
{
    IpcTask.call (this, id, "fdm_json_task");
...
function ShutdownTask (id)
{
    IpcTask.call (this, id, "shutdown");
}

function CreateDownloadsTask (id)
{
    IpcTask.call (this, id, "create_downloads");
...
function BrowserProxyTask (id)
{
    IpcTask.call (this, id, "browser_proxy");
...
function WindowTask (id)
{
    IpcTask.call (this, id, "window");
...
function VideoSnifferTask (id)
{
    IpcTask.call (this, id, "video_sniffer");
...
function SniffDllIsVideoFlashRequest(
...
function SniffDllCreateVideoDownloadFromUrlRequest(
	webPageUrl, frameUrl, swfUrl,
	flashVars, otherSwfUrls, otherFlashVars)
{
...
function NetworkRequestNotification (id, type)
{
    IpcTask.call (this, id, "network_request_notification");
    this.network_request_notification = new Object;
    this.network_request_notification.type = type;
}

function NewNetworkRequestNotification (id)
{
    NetworkRequestNotification.call (this, id, "new");
...
function NetworkRequestActivityNotification (id)
{
    NetworkRequestNotification.call (this, id, "activity");
...
function NetworkRequestResponseNotification (id)
{
    NetworkRequestNotification.call (this, id, "response");
...
function NetworkRequestResponseDataNotification (id)
{
    NetworkRequestNotification.call (this, id, "response_data");
...
function NetworkRequestResponseCompleteNotification (id)
{
    NetworkRequestNotification.call (this, id, "response_complete");
...
function BrowserDownloadStateReport (id)
{
    IpcTask.call (this, id, "browser_download_state_report");
...
function KeyStateTask (id)
{
    IpcTask.call (this, id, "key_state");
}
